				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="index.html"><span>Na</span><span>th</span></a>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-push-1 animate-box">
						<div class="about-desc">
							<div class="owl-carousel3">
								<div class="item">
									<h2><span>Nath</span><span>Zarate</span></h2>
								</div>
								<div class="item">
									<h2><span>I'm</span><span>A Computer Science Student</span></h2>
								</div>
							</div>
							<div class="desc">
								<div class="rotate">
